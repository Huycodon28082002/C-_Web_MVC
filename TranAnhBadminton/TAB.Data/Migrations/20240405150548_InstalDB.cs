    ...
    public partial class InstalDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PromotionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PromotionName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bill Details", x => new { x.ProductId, x.BillId });
                    table.ForeignKey(
                        name: "FK_Bill Details_Bills_BillId",
                        column: x => x.BillId,
                        principalTable: "Bills",
                        principalColumn: "BillId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bill Details_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product In Categories", x => new { x.CategoryId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_Product In Categories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId");
                    table.ForeignKey(
                        name: "FK_Product In Categories_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Promotion Details", x => new { x.ProductId, x.PromotionId });
                    table.ForeignKey(
                        name: "FK_Promotion Details_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Promotion Details_Promotions_PromotionId",
            ...
            migrationBuilder.InsertData(
                table: "Brands",
                columns: new[] { "BrandId", "Address", "BrandName", "NumberPhone", "Status" },
                values: new object[] { 1, "Việt Nam", "VNB", "null", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "Home Description", "Description Page" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "26 Lam Hoanh, P.An Lac, Q.Binh Tan, TP.HCM", "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.15752-9/430866613_945496816974002_8073114596546427994_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=5f2048&_nc_ohc=qNpNZ_y0TdUAX_b6ZGV&_nc_ht=scontent.fsgn5-3.fna&oh=03_AdTVWK9bgUw9-VtEDmnB6EwpiryBn-4iRLRBzGIEflDOcw&oe=662232AA", "21ea756b-a705-4249-8ff3-4d125c908602", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "kudoshinichi2804@gmail.com", true, "Kudo Shinichi", false, null, "kudoshinichi2804@gmail.com", "admin", "1", "AQAAAAIAAYagAAAAENkM3yqfoDXoButNfnjQw9aLrnUqqkwYzHAohL241zVkolV9NUofKLNoopDNTLTp/w==", "0932690343", true, "", false, "admin" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "BrandId", "CategoryName", "Status" },
                values: new object[,]
                {
                    { 1, 1, "Vợt cầu lông", 1 },
                    { 2, 1, "Giày cầu lông", 1 }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 4, 5, 22, 5, 47, 60, DateTimeKind.Local).AddTicks(7304), "Vợt thiên công nặng đầu 3U", null, 700000m, 790000m, "", "Vợt cầu lông VNB TC88C" },
                    { 2, 1, new DateTime(2024, 4, 5, 22, 5, 47, 60, DateTimeKind.Local).AddTicks(7330), "Vợt thiên công nặng đầu 3U", null, 700000m, 790000m, "", "Vợt cầu lông VNB TC88B" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Bill Details_BillId",
                table: "Bill Details",
                column: "BillId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product In Categories_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Promotion Details_PromotionId",
